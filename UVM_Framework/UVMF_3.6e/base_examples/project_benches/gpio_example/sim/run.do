...
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/gpio_example/tb/parameters $env(UVMF_PROJECT_DIR)/gpio_example/tb/parameters/gpio_example.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/gpio_example/tb/sequences $env(UVMF_PROJECT_DIR)/gpio_example/tb/sequences/gpio_example.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/gpio_example/tb/tests $env(UVMF_PROJECT_DIR)/gpio_example/tb/tests/gpio_example.sv
echo "Compile your DUT here"
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/gpio_example/tb/testbench -F $env(UVMF_PROJECT_DIR)/gpio_example/tb/testbench/top_filelist_hvl.f
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/gpio_example/tb/testbench -F $env(UVMF_PROJECT_DIR)/gpio_example/tb/testbench/top_filelist_hdl.f
