...
set ::env(UVMF_PROJECT_DIR) ../../../project_benches/ahb2spi
...
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_VIP_LIBRARY_HOME)/interface_packages/spi_pkg -F $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/spi_pkg/spi_filelist_hvl.f 
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_VIP_LIBRARY_HOME)/interface_packages/spi_pkg -F $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/spi_pkg/spi_filelist_hdl.f 
...
vlog -sv -suppress 2223 $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/wb2spi_env_pkg/registers/wb2spi_reg_pkg.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_VIP_LIBRARY_HOME)/environment_packages/wb2spi_env_pkg $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/wb2spi_env_pkg/wb2spi_env_pkg.sv
vlog -sv -suppress 2223 $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/ahb2spi_env_pkg/registers/ahb2spi_reg_pkg.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_VIP_LIBRARY_HOME)/environment_packages/ahb2spi_env_pkg $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/ahb2spi_env_pkg/ahb2spi_env_pkg.sv

vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/parameters $env(UVMF_PROJECT_DIR)/tb/parameters/ahb2spi_parameters_pkg.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/sequences $env(UVMF_PROJECT_DIR)/tb/sequences/ahb2spi_sequences_pkg.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/tests $env(UVMF_PROJECT_DIR)/tb/tests/ahb2spi_test_pkg.sv

vlog -sv -suppress 2223 $env(UVMF_PROJECT_DIR)/../ahb2wb/rtl/verilog/ahb2wb.v
vlog -sv -suppress 2223 $env(UVMF_PROJECT_DIR)/../wb2spi/rtl/verilog/wb2spi.v
vlog -sv -suppress 2223 $env(UVMF_PROJECT_DIR)/rtl/verilog/ahb2spi.v
