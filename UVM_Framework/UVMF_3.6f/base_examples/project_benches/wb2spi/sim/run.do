...
set ::env(UVMF_PROJECT_DIR) ../../../project_benches/wb2spi
...
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/parameters $env(UVMF_PROJECT_DIR)/tb/parameters/wb2spi_parameters_pkg.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/sequences $env(UVMF_PROJECT_DIR)/tb/sequences/wb2spi_sequences_pkg.sv
vlog -sv -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/tests $env(UVMF_PROJECT_DIR)/tb/tests/wb2spi_test_pkg.sv

vlog -sv -suppress 2223 -suppress 2286 $env(UVMF_PROJECT_DIR)/rtl/verilog/wb2spi.v
