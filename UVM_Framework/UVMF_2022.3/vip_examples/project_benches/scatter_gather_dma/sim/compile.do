...
## QVIP COMPILATION
###################################################################
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(QUESTA_MVC_HOME)/questa_mvc_src/sv/ -f $env(SCATTER_GATHER_DMA_QVIP_DIR_NAME)/scatter_gather_dma_qvip_filelist.f
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(SCATTER_GATHER_DMA_QVIP_DIR_NAME) $env(SCATTER_GATHER_DMA_QVIP_DIR_NAME)/hdl_scatter_gather_dma_qvip.sv
...
###################################################################
do $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/scatter_gather_dma_env_pkg/compile.do

###################################################################
## UVMF BENCHES COMPILATION
###################################################################
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/parameters $env(UVMF_PROJECT_DIR)/tb/parameters/scatter_gather_dma_parameters_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/sequences $env(UVMF_PROJECT_DIR)/tb/sequences/scatter_gather_dma_sequences_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/tests $env(UVMF_PROJECT_DIR)/tb/tests/scatter_gather_dma_tests_pkg.sv
