...
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(QUESTA_MVC_HOME)/questa_mvc_src/sv/ -f $env(QVIP_AGENTS_DIR_NAME)/qvip_agents_filelist.f
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(QVIP_AGENTS_DIR_NAME) $env(QVIP_AGENTS_DIR_NAME)/hdl_qvip_agents.sv
